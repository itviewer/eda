...
{
public:
    LineItem(PCBScene *scene,QGraphicsItem *parent = nullptr);
    LineItem(PCBScene *scene,const json &j, QGraphicsItem *parent = nullptr);
...
//    void contextMenuEvent(QGraphicsSceneContextMenuEvent *menuEvent);
