...
TextItem::TextItem(PCBScene* scene, const QString& text, QGraphicsItem* parent)
...
//{
//    pcbScene->pushCommand(new TextItemAddCommand(this),true);
//}

//void TextItem::createCommandRemove()
//{
//    pcbScene->pushCommand(new TextItemRemoveCommand(this),true);
//}
