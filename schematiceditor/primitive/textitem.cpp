...
TextItem::TextItem(SchematicScene* scene, const QString& text, QGraphicsItem* parent)
...
{
    schScene->pushCommand(new TextItemAddCommand(this),true);
}

void TextItem::createCommandRemove()
{
    schScene->pushCommand(new TextItemRemoveCommand(this),true);
}
